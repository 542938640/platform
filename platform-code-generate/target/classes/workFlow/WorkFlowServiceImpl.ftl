...
import ${config.package_name}.service.impl.BaseWorkFlowServiceImpl;
 ...
 */
@Service
public class ${config.class_name}ServiceImpl extends BaseWorkFlowServiceImpl<${config.class_name}Entity> implements ${config.class_name}Service {
