...
import ${config.package_name}.controller.BaseWorkFlowController;
...
@RestController
@RequestMapping(value="${workFlow.apiPath}")
public class ${config.class_name}Controller extends BaseWorkFlowController<${config.class_name}Entity> {
